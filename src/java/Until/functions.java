...
public class functions {
    public static final String path_upload = (new java.io.File("/home/inovemais/webapps/ROOT/upload/")).getAbsolutePath();

...
<div id="empresa">
    ...
    <div id="conteudo_empresa"> 
        <div class="links">
            <div class="link1"><a href="./index.jsp"> HOME</a> >&nbsp;</div>  <div class="link1"><a href="index.jsp?pg=servicos">SERVIÇOS</a>>&nbsp;</div>  <div class="link1"><a href="index.jsp?pg=sub_servicos_buffet">BUFFET</a> </div> 
        </div>
        <div class="clear" style="height:20px;"></div>
<!--**************************************************************conteudo_empresa***********************************-->
        <div id="serivicos_lateral">
              <div id="conteudo_foto_servicos_buffet1"> 
...
<%
                ...
                try{paginas_BEAN=(paginasBEAN)paginas_DAO.buscarTitulo("buffet").get(0);}catch(Exception erro){};

...
<div id="empresa">
    ...
    <div id="conteudo_empresa"> 
        <div class="links">
            <div class="link1"><a href="./index.jsp"> HOME</a> >&nbsp;</div>  <div class="link1"><a href="index.jsp?pg=servicos">SERVIÇOS</a>>&nbsp;</div>  <div class="link1"><a href="index.jsp?pg=sub_servicos_iluminacao">ILUMINAÇÃO E EFEITOS ESPECIAIS</a> </div> 
        </div>
        <div class="clear" style="height:20px;"></div>
<!--**************************************************************conteudo_empresa***********************************-->
        <div id="serivicos_lateral">
             <div id="conteudo_foto_servicos_iluminacao1"> 
                <div class="titulo_foto_servico" style="color:#FFFFFF;">
                    ILUMINAÇÃO E EFEITOS
                </div> 
            </div> 
            <div id="orcamento">
               <a href="./orcamento.jsp">  <img src="./imagens/servicos/pena.png" width="36" height="53" border="0"/></a>
...
<%
                ...
                try{paginas_BEAN=(paginasBEAN)paginas_DAO.buscarTitulo("iluminacao").get(0);}catch(Exception erro){};
    ...
    <!--**************************************************************conteudo_empresa***********************************-->
    <div class="texto_sub_categoria" style="color:#FF0000; margin-top: 20px;">
                FOTOS DESSE SERVIÇO
            </div>
             <%
